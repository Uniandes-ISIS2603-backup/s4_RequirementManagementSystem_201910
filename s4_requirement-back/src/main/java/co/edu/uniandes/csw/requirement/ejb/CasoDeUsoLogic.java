...
public class CasoDeUsoLogic {
     ...
     * @throws BusinessLogicException si ya existe un caso de uso con el mismo
     * nombre.
     */
    ...
    public void deleteCasoDeUso(Long requisitoId, Long casoDeUsoId) throws BusinessLogicException {
        ...
        List<CondicionEntity> condiciones = getCasoDeUso(requisitoId, casoDeUsoId).getCondiciones();
        if (condiciones != null && !condiciones.isEmpty()) {
            throw new BusinessLogicException("No se puede borrar el caso de uso con id = " + casoDeUsoId + " porque tiene condiciones asociadas");
        }
        CasoDeUsoEntity caso = getCasoDeUso(requisitoId, casoDeUsoId);
        if (caso == null) {
            throw new BusinessLogicException("El caso de uso con id = " + casoDeUsoId + " no esta asociado al requisito con id = " + requisitoId);
        }
